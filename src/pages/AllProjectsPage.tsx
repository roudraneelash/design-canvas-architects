...
import { projects, categories, getAllProjects } from '@/dummy';
...
const AllProjectsPage = () => {
  ...
  const filteredProjects = useMemo(() => {
    ...
    return (projects[activeCategory] || []).map(p => ({ ...p, category: activeCategory }));
  }, [activeCategory]);
      ...
      <div className="min-h-screen flex flex-col bg-mono-light">
        ...
        <div className="relative h-[30vh] w-full bg-mono-dark">
          <div
              ...
              style={{
                backgroundImage:
                    'url("https://images.unsplash.com/photo-1505873242700-f289a29e1e0f?auto=format&fit=crop&w=2000&q=80")',
              }}
          />
          ...
          {viewMode === 'grid' ? (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                {currentProjects.map((project) => (
                  ...
                  <span className="text-white/60 text-xs uppercase tracking-wider font-serif mb-1">
                    {project.category}
                  </span>
                        ...
                        <Link
                            ...
                            className="flex items-center text-white hover:text-[#FFA726] transition-colors font-serif text-sm font-light"
                        >
              ...
              <div className="space-y-6 mb-12">
                {currentProjects.map((project) => (
                    <div
                        key={project.id}
                        className="flex flex-col md:flex-row gap-6 bg-white p-6 border-l-4 border-mono-accent hover:shadow-lg transition-all"
                    >
                      ...
                      <span className="text-xs uppercase tracking-wider text-mono-medium font-serif">
                        {project.category}
                      </span>
